# -*- coding: utf-8 -*-
#
# pyramid_zodbconn documentation build configuration file
#
...
html_theme_options = dict(
    github_url='https://github.com/Pylons/pyramid_zodbconn',
#    in_progress='true'
    )
html_theme_options = dict(
    canonical_url='https://docs.pylonsproject.org/projects/pyramid-zodbconn/en/latest/'
)
...
latex_documents = [
  ('index', 'pyramid_zodbconn.tex', 'pyramid_zodbconn Documentation',
